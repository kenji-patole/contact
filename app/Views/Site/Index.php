...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('app-assets/css/pages/app-contacts.css');?>">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
...
<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns  app-page " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns">
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
        <div class="brand-sidebar">
            <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img class="hide-on-med-and-down " src="<?php echo base_url('app-assets/images/logo/materialize-logo.png');?>" alt="materialize logo>" /><img class="show-on-medium-and-down hide-on-med-and-up" src="<?php echo base_url('app-assets/images/logo/materialize-logo-color.png" alt="materialize logo')?>" /><span class="logo-text hide-on-med-and-down">Materialize</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
        </div>
